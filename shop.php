<?php
session_start();
$con=mysqli_connect("localhost","root","","comapany");
/*if(isset($_POST["add_to_shop"]))
{
  if(isset($_SESSION("products"))
  {
    $products_array_id=array_column($_SESSION[shop],"product_id");
    if(!in_array($_GET["id"],$products_array))
    {
    ...
    $_SESSION["shop"][$count]=$product_array;
  }
  else
  {
...
<html>
  ...
  if(mysqli_num_row($result)>0)
  {
   ...
   <img src="<?php $row["image"];?>"class="product_images"/><br />
